...
public class SafetyAdapterFactory extends AdapterFactoryImpl {
	...
	protected SafetySwitch<Adapter> modelSwitch =
		new SafetySwitch<Adapter>() {
			@Override
			public Adapter caseCriticalityInterfaceSpecification(CriticalityInterfaceSpecification object) {
				return createCriticalityInterfaceSpecificationAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseCriticalitySpecification(CriticalitySpecification object) {
				return createCriticalitySpecificationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.chessmlprofile.Safety.CriticalityInterfaceSpecification <em>Criticality Interface Specification</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.chessmlprofile.Safety.CriticalitySpecification <em>Criticality Specification</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.chessmlprofile.Safety.Hazard <em>Hazard</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.chessmlprofile.Safety.CriticalityLevel <em>Criticality Level</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
