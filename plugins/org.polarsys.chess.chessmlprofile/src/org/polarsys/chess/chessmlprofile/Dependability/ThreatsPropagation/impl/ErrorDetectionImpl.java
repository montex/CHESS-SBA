 ...
 * @generated
 */
public class ErrorDetectionImpl extends EObjectImpl implements ErrorDetection {
	/**
	...
	protected EClass eStaticClass() {
		return ThreatsPropagationPackage.Literals.ERROR_DETECTION;
	}
		...
		if (base_Transition != null && base_Transition.eIsProxy()) {
			...
			if (base_Transition != oldBase_Transition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThreatsPropagationPackage.ERROR_DETECTION__BASE_TRANSITION, oldBase_Transition, base_Transition));
			}
		}
	...
	public void setBase_Transition(Transition newBase_Transition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.ERROR_DETECTION__BASE_TRANSITION, oldBase_Transition, base_Transition));
	}
	...
	public void setDelay(String newDelay) {
		...
		delay = newDelay;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.ERROR_DETECTION__DELAY, oldDelay, delay));
	}
	...
	public void setSuccessProbability(String newSuccessProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.ERROR_DETECTION__SUCCESS_PROBABILITY, oldSuccessProbability, successProbability));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ThreatsPropagationPackage.ERROR_DETECTION__BASE_TRANSITION:
				if (resolve) return getBase_Transition();
				return basicGetBase_Transition();
			case ThreatsPropagationPackage.ERROR_DETECTION__DELAY:
				return getDelay();
