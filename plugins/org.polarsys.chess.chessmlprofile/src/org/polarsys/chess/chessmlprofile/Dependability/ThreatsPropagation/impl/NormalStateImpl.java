 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.NormalStateImpl#getBase_State <em>Base State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NormalStateImpl extends EObjectImpl implements NormalState {
		...
		if (base_State != null && base_State.eIsProxy()) {
			...
			if (base_State != oldBase_State) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThreatsPropagationPackage.NORMAL_STATE__BASE_STATE, oldBase_State, base_State));
			}
		}
		return base_State;
	}
	...
	public void setBase_State(State newBase_State) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.NORMAL_STATE__BASE_STATE, oldBase_State, base_State));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ThreatsPropagationPackage.NORMAL_STATE__BASE_STATE:
