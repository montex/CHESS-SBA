...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>CH Internal Fault</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.CHInternalFaultImpl#getBase_Transition <em>Base Transition</em>}</li>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.CHInternalFaultImpl#getPermanentProb <em>Permanent Prob</em>}</li>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.CHInternalFaultImpl#getTransfFunct <em>Transf Funct</em>}</li>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.CHInternalFaultImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.CHInternalFaultImpl#getChildFailure <em>Child Failure</em>}</li>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.CHInternalFaultImpl#getOccurrence <em>Occurrence</em>}</li>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.CHInternalFaultImpl#getTransientDuration <em>Transient Duration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CHInternalFaultImpl extends EObjectImpl implements CHInternalFault {
	/**
	...
	protected EClass eStaticClass() {
		return ThreatsPropagationPackage.Literals.CH_INTERNAL_FAULT;
	}
		...
		if (base_Transition != null && base_Transition.eIsProxy()) {
			...
			if (base_Transition != oldBase_Transition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThreatsPropagationPackage.CH_INTERNAL_FAULT__BASE_TRANSITION, oldBase_Transition, base_Transition));
			}
		}
	...
	public void setBase_Transition(Transition newBase_Transition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.CH_INTERNAL_FAULT__BASE_TRANSITION, oldBase_Transition, base_Transition));
	}
	...
	public void setPermanentProb(String newPermanentProb) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.CH_INTERNAL_FAULT__PERMANENT_PROB, oldPermanentProb, permanentProb));
	}
	...
	public void setTransfFunct(String newTransfFunct) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.CH_INTERNAL_FAULT__TRANSF_FUNCT, oldTransfFunct, transfFunct));
	}
	...
	public Property getProperty() {
		if (property != null && property.eIsProxy()) {
			...
			if (property != oldProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThreatsPropagationPackage.CH_INTERNAL_FAULT__PROPERTY, oldProperty, property));
			}
		}
		return property;
	}
	...
	public void setProperty(Property newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.CH_INTERNAL_FAULT__PROPERTY, oldProperty, property));
	}
	...
	public State getChildFailure() {
		if (childFailure != null && childFailure.eIsProxy()) {
			...
			if (childFailure != oldChildFailure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThreatsPropagationPackage.CH_INTERNAL_FAULT__CHILD_FAILURE, oldChildFailure, childFailure));
			}
		}
		return childFailure;
	}
	...
	public void setChildFailure(State newChildFailure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.CH_INTERNAL_FAULT__CHILD_FAILURE, oldChildFailure, childFailure));
	}
	...
	public void setOccurrence(String newOccurrence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.CH_INTERNAL_FAULT__OCCURRENCE, oldOccurrence, occurrence));
	}
	...
	public void setTransientDuration(String newTransientDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.CH_INTERNAL_FAULT__TRANSIENT_DURATION, oldTransientDuration, transientDuration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ThreatsPropagationPackage.CH_INTERNAL_FAULT__BASE_TRANSITION:
				if (resolve) return getBase_Transition();
				return basicGetBase_Transition();
			case ThreatsPropagationPackage.CH_INTERNAL_FAULT__PERMANENT_PROB:
				return getPermanentProb();
			case ThreatsPropagationPackage.CH_INTERNAL_FAULT__TRANSF_FUNCT:
				return getTransfFunct();
			case ThreatsPropagationPackage.CH_INTERNAL_FAULT__PROPERTY:
				if (resolve) return getProperty();
				return basicGetProperty();
			case ThreatsPropagationPackage.CH_INTERNAL_FAULT__CHILD_FAILURE:
				if (resolve) return getChildFailure();
				return basicGetChildFailure();
			case ThreatsPropagationPackage.CH_INTERNAL_FAULT__OCCURRENCE:
				return getOccurrence();
			case ThreatsPropagationPackage.CH_INTERNAL_FAULT__TRANSIENT_DURATION:
