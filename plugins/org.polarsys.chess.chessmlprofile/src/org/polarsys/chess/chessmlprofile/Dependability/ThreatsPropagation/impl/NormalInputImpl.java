 ...
 * <ul>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.NormalInputImpl#getRecovery <em>Recovery</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NormalInputImpl extends DepEventImpl implements NormalInput {
	...
	protected EClass eStaticClass() {
		return ThreatsPropagationPackage.Literals.NORMAL_INPUT;
	}
		...
		if (recovery != null && recovery.eIsProxy()) {
			...
			if (recovery != oldRecovery) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThreatsPropagationPackage.NORMAL_INPUT__RECOVERY, oldRecovery, recovery));
			}
		}
		return recovery;
	}
	...
	public void setRecovery(RecoveryEvent newRecovery) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.NORMAL_INPUT__RECOVERY, oldRecovery, recovery));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ThreatsPropagationPackage.NORMAL_INPUT__RECOVERY:
