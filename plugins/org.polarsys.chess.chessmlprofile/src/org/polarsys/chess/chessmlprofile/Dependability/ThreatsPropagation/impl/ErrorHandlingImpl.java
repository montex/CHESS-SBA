 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.ErrorHandlingImpl#getBase_Transition <em>Base Transition</em>}</li>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.ErrorHandlingImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.ErrorHandlingImpl#getSuccessProbability <em>Success Probability</em>}</li>
 *   <li>{@link org.polarsys.chess.chessmlprofile.Dependability.ThreatsPropagation.impl.ErrorHandlingImpl#getWeight <em>Weight</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorHandlingImpl extends EObjectImpl implements ErrorHandling {
		...
		if (base_Transition != null && base_Transition.eIsProxy()) {
			...
			if (base_Transition != oldBase_Transition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ThreatsPropagationPackage.ERROR_HANDLING__BASE_TRANSITION, oldBase_Transition, base_Transition));
			}
		}
	...
	public void setBase_Transition(Transition newBase_Transition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.ERROR_HANDLING__BASE_TRANSITION, oldBase_Transition, base_Transition));
	}
	...
	public void setDelay(String newDelay) {
		...
		delay = newDelay;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.ERROR_HANDLING__DELAY, oldDelay, delay));
	}
	...
	public void setSuccessProbability(String newSuccessProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.ERROR_HANDLING__SUCCESS_PROBABILITY, oldSuccessProbability, successProbability));
	}
	...
	public void setWeight(String newWeight) {
		...
		weight = newWeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ThreatsPropagationPackage.ERROR_HANDLING__WEIGHT, oldWeight, weight));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ThreatsPropagationPackage.ERROR_HANDLING__BASE_TRANSITION:
				if (resolve) return getBase_Transition();
				return basicGetBase_Transition();
			case ThreatsPropagationPackage.ERROR_HANDLING__DELAY:
				return getDelay();
			case ThreatsPropagationPackage.ERROR_HANDLING__SUCCESS_PROBABILITY:
				return getSuccessProbability();
			case ThreatsPropagationPackage.ERROR_HANDLING__WEIGHT:
				return getWeight();
		}
