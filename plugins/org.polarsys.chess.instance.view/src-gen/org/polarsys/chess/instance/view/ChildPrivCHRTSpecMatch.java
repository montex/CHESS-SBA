...
public abstract class ChildPrivCHRTSpecMatch extends BasePatternMatch {
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("privoperation".equals(parameterName) ) {
    	this.fPrivoperation = (org.eclipse.uml2.uml.BehavioralFeature) newValue;
    	return true;
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    result = prime * result + ((fPrivoperation == null) ? 0 : fPrivoperation.hashCode());
    return result;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ChildPrivCHRTSpecMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    if (fPrivoperation == null) {if (other.fPrivoperation != null) return false;}
    else if (!fPrivoperation.equals(other.fPrivoperation)) return false;
    return true;
  }
