...
public class PatternsProfileAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected PatternsProfileSwitch<Adapter> modelSwitch =
		new PatternsProfileSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.patterns.profile.PatternsProfile.Pattern <em>Pattern</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.patterns.profile.PatternsProfile.PatternApplication <em>Pattern Application</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.patterns.profile.PatternsProfile.PatternRole <em>Pattern Role</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
