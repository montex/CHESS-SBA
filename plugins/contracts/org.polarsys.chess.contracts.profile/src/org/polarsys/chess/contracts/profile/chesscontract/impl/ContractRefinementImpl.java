 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractRefinementImpl#getBase_DataType
 * <em>Base Data Type</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractRefinementImpl#getInstance
 * <em>Instance</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractRefinementImpl#getContract
 * <em>Contract</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractRefinementImpl#getInstanceSpec
...
public class ContractRefinementImpl extends MinimalEObjectImpl.Container implements ContractRefinement {
	/**
	 * The cached value of the '{@link #getBase_DataType() <em>Base Data
	...
	/**
	 * The cached value of the '{@link #getInstanceSpec() <em>Instance
	 * Spec</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getInstanceSpec()
	 * @generated
	 * @ordered
			...
			if (base_DataType != oldBase_DataType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CHESSContractPackage.CONTRACT_REFINEMENT__BASE_DATA_TYPE, oldBase_DataType, base_DataType));
			}
		}
	...
	public Property getInstance() {
		if (instance != null && instance.eIsProxy()) {
			...
			if (instance != oldInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CHESSContractPackage.CONTRACT_REFINEMENT__INSTANCE, oldInstance, instance));
			}
		}
		return instance;
	}
	...
	public void setInstance(Property newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CONTRACT_REFINEMENT__INSTANCE,
	...
	public ContractProperty getContract() {
		if (contract != null && contract.eIsProxy()) {
			...
			if (contract != oldContract) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CHESSContractPackage.CONTRACT_REFINEMENT__CONTRACT, oldContract, contract));
			}
		}
		return contract;
	}
	...
	public void setContract(ContractProperty newContract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CONTRACT_REFINEMENT__CONTRACT,
	...
	public InstanceSpecification getInstanceSpec() {
		if (instanceSpec != null && instanceSpec.eIsProxy()) {
			...
			if (instanceSpec != oldInstanceSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CHESSContractPackage.CONTRACT_REFINEMENT__INSTANCE_SPEC, oldInstanceSpec, instanceSpec));
			}
		}
		return instanceSpec;
	}
