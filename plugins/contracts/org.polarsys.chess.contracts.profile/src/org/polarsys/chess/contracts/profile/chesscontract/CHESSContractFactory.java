...
public interface CHESSContractFactory extends EFactory {
	 ...
	 * @generated
	 */
	CHESSContractFactory eINSTANCE = org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSContractFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>System</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Contract Refinement Analysis
	 * Context</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return a new object of class '<em>Contract Refinement Analysis
	 *         Context</em>'.
	 * @generated
	 */
	...
	/**
	 * Returns a new object of class '<em>Formalize</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
