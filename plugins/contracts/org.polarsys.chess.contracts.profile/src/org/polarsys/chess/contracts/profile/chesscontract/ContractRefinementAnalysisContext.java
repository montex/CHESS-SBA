 ...
 *
 * <!-- begin-model-doc --> I am not able to generate the static definition of
 * the profile having this stereotype extending the MARTE GaANalysisContext, I
 * obtaind some errors in the genmodel related to the MARTE URI... for the
 * moment, as temporary solution, I define it as extension of Class. <!--
 * end-model-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.ContractRefinementAnalysisContext#isCheckAllWeakContracts
...
public interface ContractRefinementAnalysisContext extends GaAnalysisContext {
	/**
	 * Returns the value of the '<em><b>Check All Weak Contracts</b></em>'
	 ...
	 * @model default="false" dataType="org.eclipse.uml2.types.Boolean"
	 ...
	 * <em>Check All Weak Contracts</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Check All Weak Contracts</em>'
	 *            attribute.
