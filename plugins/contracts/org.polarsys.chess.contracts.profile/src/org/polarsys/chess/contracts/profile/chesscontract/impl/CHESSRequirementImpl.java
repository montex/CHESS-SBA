 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSRequirementImpl#getAuthor
 * <em>Author</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSRequirementImpl#getStatus
 * <em>Status</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSRequirementImpl#getType
 * <em>Type</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSRequirementImpl#getPriority
 * <em>Priority</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSRequirementImpl#getPerformance
 * <em>Performance</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSRequirementImpl#getTolerance
 * <em>Tolerance</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSRequirementImpl#getSeverity
 * <em>Severity</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSRequirementImpl#getMaturity
 * <em>Maturity</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.CHESSRequirementImpl#getRisk
 * <em>Risk</em>}</li>
 * </ul>
 *
 * @generated
...
public class CHESSRequirementImpl extends RequirementImpl implements CHESSRequirement {
	...
	/**
	 * The default value of the '{@link #getPerformance() <em>Performance</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getPerformance()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPerformance() <em>Performance</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getPerformance()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getMaturity() <em>Maturity</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getMaturity()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getMaturity() <em>Maturity</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getMaturity()
	 * @generated
	...
	public void setAuthor(String newAuthor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CHESS_REQUIREMENT__AUTHOR,
					oldAuthor, author));
	}
	...
	public void setStatus(ReqStatuses newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CHESS_REQUIREMENT__STATUS,
					oldStatus, status));
	}
	...
	public void setType(ReqTypes newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CHESS_REQUIREMENT__TYPE, oldType,
					type));
	}
	...
	public void setPriority(ReqPriorities newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CHESS_REQUIREMENT__PRIORITY,
	...
	public void setPerformance(String newPerformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CHESS_REQUIREMENT__PERFORMANCE,
	...
	public void setTolerance(String newTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CHESS_REQUIREMENT__TOLERANCE,
	...
	public void setSeverity(String newSeverity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CHESS_REQUIREMENT__SEVERITY,
	...
	public void setMaturity(ReqMaturities newMaturity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CHESS_REQUIREMENT__MATURITY,
	...
	public void setRisk(ReqRisks newRisk) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CHESS_REQUIREMENT__RISK, oldRisk,
					risk));
	}
