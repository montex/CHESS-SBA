 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.FormalizeImpl#getBase_Abstraction
...
public class FormalizeImpl extends MinimalEObjectImpl.Container implements Formalize {
			...
			if (base_Abstraction != oldBase_Abstraction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CHESSContractPackage.FORMALIZE__BASE_ABSTRACTION, oldBase_Abstraction, base_Abstraction));
			}
		}
	...
	public void setBase_Abstraction(Abstraction newBase_Abstraction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FORMALIZE__BASE_ABSTRACTION,
