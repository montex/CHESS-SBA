...
public class DataTypesAdapterFactory extends AdapterFactoryImpl {
	...
	protected DataTypesSwitch<Adapter> modelSwitch = new DataTypesSwitch<Adapter>() {
			@Override
			public Adapter caseOthelloConstraint(OthelloConstraint object) {
				return createOthelloConstraintAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.contracts.profile.chesscontract.DataTypes.OthelloConstraint <em>Othello Constraint</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.contracts.profile.chesscontract.DataTypes.Continuous <em>Continuous</em>}'.
	 * <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
