...
public enum ReqStatuses implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ReqStatuses[] VALUES_ARRAY = new ReqStatuses[] { INITIAL, DERIVED, FINAL, };

	/**
	 * A public read-only list of all the '<em><b>Req Statuses</b></em>'
	...
	/**
	 * Returns the '<em><b>Req Statuses</b></em>' literal with the specified
