 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractImpl#getAssume
 * <em>Assume</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractImpl#getGuarantee
 * <em>Guarantee</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractImpl#getFormalize
 * <em>Formalize</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractImpl#getLanguage
 * <em>Language</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractImpl#getContextStatement
 * <em>Context Statement</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractImpl#getArtefactStatement
...
public class ContractImpl extends ConstraintBlockImpl implements Contract {
	...
	/**
	 * The cached value of the '{@link #getGuarantee() <em>Guarantee</em>}'
	...
	/**
	 * The cached value of the '{@link #getFormalize() <em>Formalize</em>}'
	...
	/**
	 * The default value of the '{@link #getContextStatement() <em>Context
	 * Statement</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getContextStatement() <em>Context
	 * Statement</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getContextStatement()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getArtefactStatement() <em>Artefact
	 * Statement</em>}' attribute list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
		...
		if (assume != null && assume.eIsProxy()) {
			...
			if (assume != oldAssume) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CHESSContractPackage.CONTRACT__ASSUME,
							oldAssume, assume));
			}
		}
		return assume;
	...
	public void setAssume(FormalProperty newAssume) {
		...
		assume = newAssume;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CONTRACT__ASSUME, oldAssume,
					assume));
	}
	...
	public FormalProperty getGuarantee() {
		if (guarantee != null && guarantee.eIsProxy()) {
			...
			if (guarantee != oldGuarantee) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CHESSContractPackage.CONTRACT__GUARANTEE,
	...
	public void setGuarantee(FormalProperty newGuarantee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CONTRACT__GUARANTEE,
					oldGuarantee, guarantee));
	}
	...
	public EList<Requirement> getFormalize() {
		if (formalize == null) {
			formalize = new EObjectResolvingEList<Requirement>(Requirement.class, this,
					CHESSContractPackage.CONTRACT__FORMALIZE);
		}
		return formalize;
	}
	...
	public void setLanguage(Languages newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CONTRACT__LANGUAGE, oldLanguage,
					language));
	}
	...
	public void setContextStatement(String newContextStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CONTRACT__CONTEXT_STATEMENT,
					oldContextStatement, contextStatement));
	}
	...
	public EList<String> getArtefactStatement() {
		if (artefactStatement == null) {
			artefactStatement = new EDataTypeUniqueEList<String>(String.class, this,
					CHESSContractPackage.CONTRACT__ARTEFACT_STATEMENT);
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case CHESSContractPackage.CONTRACT__CONTEXT_STATEMENT:
			return CONTEXT_STATEMENT_EDEFAULT == null ? contextStatement != null
					: !CONTEXT_STATEMENT_EDEFAULT.equals(contextStatement);
		case CHESSContractPackage.CONTRACT__ARTEFACT_STATEMENT:
