 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractPropertyImpl#getRefinedBy
 * <em>Refined By</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractPropertyImpl#getContractType
 * <em>Contract Type</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractPropertyImpl#getBase_Slot
 * <em>Base Slot</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ContractPropertyImpl#getStatus
 * <em>Status</em>}</li>
 * </ul>
 *
 * @generated
...
public class ContractPropertyImpl extends ConstraintPropertyImpl implements ContractProperty {
	/**
	 * The cached value of the '{@link #getRefinedBy() <em>Refined By</em>}'
	...
	/**
	 * The default value of the '{@link #getContractType() <em>Contract
	...
	/**
	 * The cached value of the '{@link #getContractType() <em>Contract
	 * Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getContractType()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getBase_Slot() <em>Base Slot</em>}'
	...
	public EList<ContractRefinement> getRefinedBy() {
		if (refinedBy == null) {
			refinedBy = new EObjectResolvingEList<ContractRefinement>(ContractRefinement.class, this,
					CHESSContractPackage.CONTRACT_PROPERTY__REFINED_BY);
		}
		return refinedBy;
	}
	...
	public void setContractType(ContractTypes newContractType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CONTRACT_PROPERTY__CONTRACT_TYPE,
			...
			if (base_Slot != oldBase_Slot) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CHESSContractPackage.CONTRACT_PROPERTY__BASE_SLOT, oldBase_Slot, base_Slot));
			}
		}
		return base_Slot;
	}
	...
	public void setBase_Slot(Slot newBase_Slot) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CONTRACT_PROPERTY__BASE_SLOT,
					oldBase_Slot, base_Slot));
	}
	...
	public void setStatus(ContractStatus newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.CONTRACT_PROPERTY__STATUS,
					oldStatus, status));
	}
