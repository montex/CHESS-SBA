...
public class DataTypesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DataTypesPackage.OTHELLO_CONSTRAINT: {
				OthelloConstraint othelloConstraint = (OthelloConstraint)theEObject;
				T result = caseOthelloConstraint(othelloConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataTypesPackage.CONTINUOUS: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Othello Constraint</em>'.
	 * <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate
	 * the switch. <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Othello Constraint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOthelloConstraint(OthelloConstraint object) {
		return null;
	}
