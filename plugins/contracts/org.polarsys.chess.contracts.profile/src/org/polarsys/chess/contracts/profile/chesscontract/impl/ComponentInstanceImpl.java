 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ComponentInstanceImpl#getBase_Property
 * <em>Base Property</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ComponentInstanceImpl#getWeakGuarantees
 * <em>Weak Guarantees</em>}</li>
 * <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ComponentInstanceImpl#getBase_InstanceSpecification
...
public class ComponentInstanceImpl extends MinimalEObjectImpl.Container implements ComponentInstance {
	/**
	 * The cached value of the '{@link #getBase_Property() <em>Base
	...
	/**
	 * The cached value of the '{@link #getWeakGuarantees() <em>Weak
	 * Guarantees</em>}' reference list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getBase_InstanceSpecification() <em>Base
	 * Instance Specification</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
			...
			if (base_Property != oldBase_Property) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CHESSContractPackage.COMPONENT_INSTANCE__BASE_PROPERTY, oldBase_Property, base_Property));
			}
		}
	...
	public EList<ContractProperty> getWeakGuarantees() {
		if (weakGuarantees == null) {
			weakGuarantees = new EObjectResolvingEList<ContractProperty>(ContractProperty.class, this,
					CHESSContractPackage.COMPONENT_INSTANCE__WEAK_GUARANTEES);
		}
	...
	public InstanceSpecification getBase_InstanceSpecification() {
		if (base_InstanceSpecification != null && base_InstanceSpecification.eIsProxy()) {
			...
			if (base_InstanceSpecification != oldBase_InstanceSpecification) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CHESSContractPackage.COMPONENT_INSTANCE__BASE_INSTANCE_SPECIFICATION,
	...
	public void setBase_InstanceSpecification(InstanceSpecification newBase_InstanceSpecification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CHESSContractPackage.COMPONENT_INSTANCE__BASE_INSTANCE_SPECIFICATION, oldBase_InstanceSpecification,
