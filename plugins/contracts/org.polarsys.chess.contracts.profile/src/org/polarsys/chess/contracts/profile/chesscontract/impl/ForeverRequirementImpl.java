...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Forever Requirement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ForeverRequirementImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ForeverRequirementImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ForeverRequirementImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ForeverRequirementImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ForeverRequirementImpl#getPerformance <em>Performance</em>}</li>
 *   <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ForeverRequirementImpl#getTolerance <em>Tolerance</em>}</li>
 *   <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ForeverRequirementImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ForeverRequirementImpl#getMaturity <em>Maturity</em>}</li>
 *   <li>{@link org.polarsys.chess.contracts.profile.chesscontract.impl.ForeverRequirementImpl#getRisk <em>Risk</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForeverRequirementImpl extends RequirementImpl implements ForeverRequirement {
	 ...
	 * @generated
	 */
	protected ForeverRequirementImpl() {
		super();
	}
	...
	public void setAuthor(String newAuthor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FOREVER_REQUIREMENT__AUTHOR, oldAuthor, author));
	}
	...
	public void setStatus(ReqStatuses newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FOREVER_REQUIREMENT__STATUS, oldStatus, status));
	}
	...
	public void setType(ReqTypes newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FOREVER_REQUIREMENT__TYPE, oldType, type));
	}
	...
	public void setPriority(ReqPriorities newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FOREVER_REQUIREMENT__PRIORITY, oldPriority, priority));
	}
	...
	public void setPerformance(String newPerformance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FOREVER_REQUIREMENT__PERFORMANCE, oldPerformance, performance));
	}
	...
	public void setTolerance(String newTolerance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FOREVER_REQUIREMENT__TOLERANCE, oldTolerance, tolerance));
	}
	...
	public void setSeverity(String newSeverity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FOREVER_REQUIREMENT__SEVERITY, oldSeverity, severity));
	}
	...
	public void setMaturity(ReqMaturities newMaturity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FOREVER_REQUIREMENT__MATURITY, oldMaturity, maturity));
	}
	...
	public void setRisk(ReqRisks newRisk) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSContractPackage.FOREVER_REQUIREMENT__RISK, oldRisk, risk));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CHESSContractPackage.FOREVER_REQUIREMENT__AUTHOR:
				return getAuthor();
			case CHESSContractPackage.FOREVER_REQUIREMENT__STATUS:
				return getStatus();
			case CHESSContractPackage.FOREVER_REQUIREMENT__TYPE:
				return getType();
			case CHESSContractPackage.FOREVER_REQUIREMENT__PRIORITY:
				return getPriority();
			case CHESSContractPackage.FOREVER_REQUIREMENT__PERFORMANCE:
				return getPerformance();
			case CHESSContractPackage.FOREVER_REQUIREMENT__TOLERANCE:
				return getTolerance();
			case CHESSContractPackage.FOREVER_REQUIREMENT__SEVERITY:
				return getSeverity();
			case CHESSContractPackage.FOREVER_REQUIREMENT__MATURITY:
				return getMaturity();
			case CHESSContractPackage.FOREVER_REQUIREMENT__RISK:
				return getRisk();
		}
