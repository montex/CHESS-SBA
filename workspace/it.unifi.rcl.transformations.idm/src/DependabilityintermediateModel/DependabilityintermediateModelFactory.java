...
public interface DependabilityintermediateModelFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Errors Produces Failures</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Errors Produces Failures</em>'.
	 * @generated
	 */
	ErrorsProducesFailures createErrorsProducesFailures();
