...
/**
 * This is the item provider adapter for a {@link DependabilityintermediateModel.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_Component_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_Component_feature", "_UI_Activity_type"),
				 DependabilityintermediateModelPackage.Literals.ACTIVITY__COMPONENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DependabilityintermediateModelPackage.Literals.ACTIVITY__DURATION);
			childrenFeatures.add(DependabilityintermediateModelPackage.Literals.ACTIVITY__WHEN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.ACTIVITY__DURATION,
		...
		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.ACTIVITY__WHEN,
				 DependabilityintermediateModelFactory.eINSTANCE.createScheduleImmediately()));

		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.ACTIVITY__WHEN,
				 DependabilityintermediateModelFactory.eINSTANCE.createScheduleAtTime()));

		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.ACTIVITY__WHEN,
				 DependabilityintermediateModelFactory.eINSTANCE.createSchedulePeriodic()));
	}
