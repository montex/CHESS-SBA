...
/**
 * This is the item provider adapter for a {@link DependabilityintermediateModel.Error} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ErrorItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DependabilityintermediateModelPackage.Literals.ERROR__VANISHING_TIME);
		}
	...
	public String getText(Object object) {
		String label = ((DependabilityintermediateModel.Error)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DependabilityintermediateModel.Error.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.ERROR__VANISHING_TIME,
