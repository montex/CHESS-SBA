...
/**
 * This is the item provider adapter for a {@link DependabilityintermediateModel.Exponential} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExponentialItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Exponential_Rate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Exponential_Rate_feature", "_UI_Exponential_type"),
				 DependabilityintermediateModelPackage.Literals.EXPONENTIAL__RATE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Exponential_type") + " " + exponential.getRate();
	}
