...
/**
 * This is the item provider adapter for a {@link DependabilityintermediateModel.SchedulingEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchedulingEventItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DependabilityintermediateModelPackage.Literals.SCHEDULING_EVENT__CONDITION);
		}
	...
	public String getText(Object object) {
		return getString("_UI_SchedulingEvent_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SchedulingEvent.class)) {
			case DependabilityintermediateModelPackage.SCHEDULING_EVENT__CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.SCHEDULING_EVENT__CONDITION,
