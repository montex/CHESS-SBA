...
/**
 * This is the item provider adapter for a {@link DependabilityintermediateModel.Sistema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SistemaItemProvider
	...
	public String getText(Object object) {
		String label = ((Sistema)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.SISTEMA__COMPONENTS,
				 DependabilityintermediateModelFactory.eINSTANCE.createComponent()));

		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.SISTEMA__ACTIVITIES,
				 DependabilityintermediateModelFactory.eINSTANCE.createMaintenanceActivity()));

		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.SISTEMA__ACTIVITIES,
				 DependabilityintermediateModelFactory.eINSTANCE.createRepairActivity()));

		newChildDescriptors.add
			(createChildParameter
				(DependabilityintermediateModelPackage.Literals.SISTEMA__ACTIVITIES,
				 DependabilityintermediateModelFactory.eINSTANCE.createReplaceActivity()));
