...
plot './results-model4review.txt' u 1:4 ev ::0:0:6:0 t "fo = 1.0E-05 hours^{-1}" w lp,\
	 './results-model4review.txt' u 1:4 ev ::0:1:6:1 t "fo = 5.0E-05 hours^{-1}" w lp
...
plot './results-model4review.txt' u 1:4 ev :::0::0 t 'p=1.0' w lp,\
	 './results-model4review.txt' u 1:4 ev :::2::2 t 'p=0.5' w lp
